...
namespace ServiceBusProcessor
{
    public class Functions
    {
        ...
        public async Task Test1Receive1([ServiceBusTrigger("%AzureTestHarness:ServiceBus:Test1Topic1Name%", "%AzureTestHarness:ServiceBus:Test1Subscription1Name%", Connection = "AzureTestHarness:ServiceBus:ConnectionString")] Guid messageId,
            ILogger logger)
        {
            try
            {
